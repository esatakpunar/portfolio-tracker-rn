export default {
  ...
  priceSourceSubtitle: 'Where to fetch price data from?',
  priceSourceAuto: 'Automatic (Recommended)',
  priceSourceAutoDesc: 'Try Truncgil, fallback to Investing.com',
  priceSourceTruncgil: 'Truncgil API',
  priceSourceTruncgilDesc: 'Truncgil only',
  priceSourceInvesting: 'Investing.com',
  priceSourceInvestingDesc: 'Investing.com only',
