export default {
  ...
  priceSourceSubtitle: 'Woher sollen die Preisdaten kommen?',
  priceSourceAuto: 'Automatisch (Empfohlen)',
  priceSourceAutoDesc: 'Versuche Truncgil, Fallback zu Investing.com',
  priceSourceTruncgil: 'Truncgil API',
  priceSourceTruncgilDesc: 'Nur Truncgil',
  priceSourceInvesting: 'Investing.com',
  priceSourceInvestingDesc: 'Nur Investing.com',
  ...
  usingOldBackupData: 'Alte Backup-Daten werden verwendet (älter als 24 Stunden)',
