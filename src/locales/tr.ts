export default {
  ...
  priceSourceSubtitle: 'Fiyat verisi nereden alınsın?',
  priceSourceAuto: 'Otomatik (Önerilen)',
  priceSourceAutoDesc: 'Truncgil dene, başarısız olursa Investing.com',
  priceSourceTruncgil: 'Truncgil API',
  priceSourceTruncgilDesc: 'Sadece Truncgil',
  priceSourceInvesting: 'Investing.com',
  priceSourceInvestingDesc: 'Sadece Investing.com',
  error: 'Hata oluştu',
  success: 'Başarılı',
  retry: 'Tekrar Dene',
